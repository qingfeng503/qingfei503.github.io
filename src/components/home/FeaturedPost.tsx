...
export function FeaturedPost({ post }: FeaturedPostProps) {
    ...
    return (
        <Link href={post.url as `/posts/${string}/${string}`}>
            ...
            >
                <div className="absolute -right-8 -top-8 h-24 w-24 rotate-12 bg-gradient-to-br from-blue-500/10 to-emerald-500/10 blur-2xl transition-all group-hover:rotate-45" />
                <div className="relative grid gap-6 p-6 md:grid-cols-2 md:gap-8 md:p-8">
                    <div className="flex flex-col justify-center space-y-3">
                        <div className="space-y-1">
                            ...
                            <h2 className="text-xl font-bold text-gray-900 transition-colors group-hover:text-blue-500 dark:text-gray-100 dark:group-hover:text-blue-400 md:text-2xl">
                                {post.title}
                            </h2>
                        </div>
                    ...
                    <div className="relative aspect-[16/9] overflow-hidden rounded-xl md:aspect-[4/3]">
                        <BlurImage
                            src={post.cover}
                            alt={post.title}
                            fill
